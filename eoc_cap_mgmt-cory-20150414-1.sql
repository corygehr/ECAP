...
CREATE TABLE `globals` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Date/Time of Last Update',
  PRIMARY KEY (`name`)
...
INSERT INTO `globals` VALUES ('PASSWORD_SALT','TheTechBots2015','2015-04-14 18:58:52');
...
INSERT INTO `user_passwords` VALUES ('cmg5573','616bd9499ec6e80fb0dd5c2433f694a09040a16423ee1d704991ad19e8f8fc22');
...
CREATE TABLE `users` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Date/Time of Last Row Update',
  `delete_time` datetime DEFAULT NULL COMMENT 'Date/Time of User Deletion',
  PRIMARY KEY (`username`),
...
-- Dump completed on 2015-04-14 16:16:41
